...
/**
 * Attempted implementation of old ForgeDirection array for 1.8.9
 *
...
public enum RotationalDirection {
    ...
    /**
     * Used by getOrientation, for invalid inputs
     */
    UNKNOWN(0, 0, 0);
    ...
    public static final RotationalDirection[] VALID_DIRECTIONS = {DOWN, UP, NORTH, SOUTH, WEST, EAST};
    ...
    RotationalDirection(int x, int y, int z)
    {
        offsetX = x;
        offsetY = y;
        offsetZ = z;
    ...
    public static RotationalDirection getOrientation(int id)
    {
    ...
    public RotationalDirection getOpposite()
    {
        return getOrientation(OPPOSITES[ordinal()]);
    }

    public RotationalDirection getRotation(RotationalDirection axis)
    {
